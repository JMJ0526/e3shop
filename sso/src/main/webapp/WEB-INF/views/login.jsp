...
<script type="text/javascript" src="${ctx }/js/png.js"></script>
<script type="text/javascript" src="${ctx }/js/cas.login.js"></script>
<script type="text/javascript" src="${ctx }/js/capsLock.js"></script>
</head>
<body>
	<!-- header -->
	<div class="header">
		<a href="http://www.e3mall.cn"><img src="${ctx}/images/logo.png" border="0"><span>欢迎登录</span></a>
	</div>
	<!-- login_main -->
	<div class="login_main clear">
		<div class="pic">
			<a href="http://www.e3mall.cn/html/activity/1472720729.html" target="_blank"><img src="${ctx}/images/06f42c372620f92b40da77a8b23cdf7f.png"></a>
		</div>
		<!-- login -->
		<div class="login">
			<div class="login_header">
    	<span>您还未登录</span>
    	<a href="${ctx }/page/register">免费注册</a>
    </div>
	...
	var LOGIN = {
			...
			doLogin:function() {
				$.post("${ctx}/user/login", $("#formlogin").serialize(),function(data){
					if (data.status == 200) {
						jAlert('登录成功！',"提示", function(){
							if (redirectUrl == "") {
								location.href = "http://localhost:10001/e3-front-web/index.html";
							} else {
