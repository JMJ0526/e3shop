  ...
  <div class="header_inner">
    <div class="logo">
        ...
        <div class="index_topad" id="playLogo" style="">
            <a href="${ctx }/html/activity/1472179566.html" target="_blank">
              <img src="${ctx }/images/html/20160829181637762.gif">
            </a> 
        </div>
		<a name="sfbest_hp_hp_head_logo" href="http://www.e3mall.cn" class="trackref logoleft">
		</a>
		<div class="logo-text">
			<img src="${ctx }/images/html/logo_word.jpg">
		</div>
		</div>
    <div class="index_promo"></div>
    <div class="search">
      <form action="${ctx }/search.html" id="searchForm" name="query" method="GET">
