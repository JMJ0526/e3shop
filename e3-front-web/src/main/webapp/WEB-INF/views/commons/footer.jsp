...
<li><a rel="nofollow" href="http://help.e3mall.cn/392/7232.html" target="_blank">商家规则</a></li>
	...
	<div class="bottom_kx">
	<!--可信网站图片LOGO安装开始-->
	<a id="cnnic" href="https://ss.knet.cn/verifyseal.dll?sn=e14052911011349517cnbv000000&amp;ct=df&amp;pa=0.294005" rel="nofollow" target="_blank"><img onclick="CNNIC_change('cnnic')" src="${ctx }/images/kxicon.jpg" border="0"></a>
	...
	<div class="bottom_sm"><a id="_pingansec_bottomimagesmall_shiming" href="http://si.trustutn.org/info?sn=332160125020173365693&amp;certType=1" target="_blank"><img src="${ctx }/images/bottom_sm.png"></a></div>
