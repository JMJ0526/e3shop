...
<div class="topMenu">
    ...
    <ul class="fr topTh">
      <li class="login" id="login">
      	<span id="loginbar" style="margin-right: 15px;">
	      	<a href="http://localhost:8082/sso/page/login">请登录</a>
      	</span>
      	<a href="http://localhost:8082/sso/page/register">免费注册</a>
      </li>
  ...
  <script type="text/javascript" src="${ctx }/desc_js/e3mall.js"></script>
  <script type="text/javascript" src="${ctx }/desc_js/jquery.cookie.js"></script>
</div>